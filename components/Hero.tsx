          ...
          <div className="lg:col-span-1">
            <div className="text-center lg:text-left">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-slate-900 tracking-tight">
                Settle contract disputes in{" "}
                <span className="text-teal-600">days</span>, not months.
              </h1>
              <p className="mt-6 max-w-xl mx-auto lg:mx-0 text-lg sm:text-xl text-slate-600">
                Pact.ai is the arbitration AI helping freelancers, agencies, and
                small businesses resolve disputes faster, enforce scope, and get
                paid.
              </p>
